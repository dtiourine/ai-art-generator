...
def generate_noise_vector(dim=100):
    """
    ...
    """
    return torch.rand(1, dim, 1, 1, dtype=torch.float32)
...
def generate_image_tensor_from_noise_vector(noise_vector, generator):
    ...
    :return: A pytorch tensor of shape (3, 256, 256) representing the generated image
    """
    with torch.no_grad():
